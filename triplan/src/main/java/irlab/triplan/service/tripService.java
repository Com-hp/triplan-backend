...
public interface tripService {
    Map<String, Object> getGroupInTrip(Integer group_id);
    List<tripDTO> getGroupDate(Integer group_id);
    Map<String, Object> CreateTrip(Integer group_id, MultipartFile trip_path, String trip_name, LocalDate start_date, LocalDate end_date);
